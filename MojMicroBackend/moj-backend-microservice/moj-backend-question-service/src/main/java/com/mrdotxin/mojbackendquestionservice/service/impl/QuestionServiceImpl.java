...
import com.mrdotxin.moj.backend.common.exception.ThrowUtils;
import com.mrdotxin.moj.backend.common.utils.SqlUtils;
import com.mrdotxin.moj.backend.model.dto.question.QuestionQueryRequest;
import com.mrdotxin.moj.backend.model.entity.Question;
import com.mrdotxin.moj.backend.model.entity.User;
import com.mrdotxin.moj.backend.model.vo.QuestionVO;
import com.mrdotxin.moj.backend.model.vo.UserVO;
import com.mrdotxin.mojbackendquestionservice.mapper.QuestionMapper;
...
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    public void validQuestion(Question question, boolean add) {
        ...
        if (StringUtils.isNotBlank(judgeConfig) && judgeConfig.length() > 8192) {
            throw new BusinessException(ErrorCode.PARAMS_ERROR, "判题配置");
        }
    }
    ...
    public QueryWrapper<Question> getQueryWrapper(QuestionQueryRequest questionQueryRequest) {
        ...
        String sortFiled = questionQueryRequest.getSortField();
